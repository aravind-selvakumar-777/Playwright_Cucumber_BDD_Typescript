...
Feature: To contain the scenarios related to PIM page of Orange HRM.
    ...
    Scenario: Add a new employee with mandatory fields
        ...
        And the user enters employee first name "Shinra" and last name "Kusakabe"
        And enters a random employee id
        And the user clicks the "Save" button
        Then the "Personal Details" page for the employee should be displayed along with name "Shinra Kusakabe"
